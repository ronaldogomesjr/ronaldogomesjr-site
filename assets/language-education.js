(function () {
  ...
  const ROOT_SELECTOR = '[data-language-page]';
  const LEGACY_URL = '/content/educacao-linguistica.json';
  ...
  const SELECTORS = {"title":["[data-language-title]"],"intro":["[data-language-intro]"],"section1_title":["[data-language-perspective-title]"],"section1_text":["[data-language-perspective-text]"]};
