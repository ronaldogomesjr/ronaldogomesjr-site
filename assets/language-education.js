(function () {
  ...
  const RAW_URL = 'https://raw.githubusercontent.com/ronaldogomesjr/ronaldogomesjr-site/main/content/educacao-linguistica.json';
  const LOCAL_URL = '/content/educacao-linguistica.json';
  ...
  async function render() {
    ...
    setText(root, '[data-language-title]', localized(data, 'title', lang));
    setText(root, '[data-language-intro]', localized(data, 'intro', lang));
    setText(root, '[data-language-perspective-title]', localized(data, 'perspective_title', lang));
    setText(root, '[data-language-perspective-text]', localized(data, 'perspective_text', lang));
  ...
  document.addEventListener('DOMContentLoaded', () => {
    render().catch((error) => console.error('Não foi possível atualizar o conteúdo da página Educação linguística.', error));
  });
})();
