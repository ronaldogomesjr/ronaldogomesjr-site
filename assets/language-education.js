(function () {
  ...
  const PAGE_ID = 'educacao-linguistica';
  ...
  async function render() {
    ...
    if (!page) throw new Error('Página Educação linguística não encontrada em content/pages.json.');

    setText(root, '[data-language-title]', value(page, 'title', lang));
    setText(root, '[data-language-intro]', value(page, 'intro', lang));
    setText(root, '[data-language-perspective-title]', value(page, 'section1_title', lang));
    setText(root, '[data-language-perspective-text]', value(page, 'section1_text', lang));
