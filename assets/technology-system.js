(function () {
  ...
  const ROOT_SELECTOR = '[data-tech-page]';
  const LEGACY_URL = '/content/tecnologia-digital.json';
  ...
  const SELECTORS = {"title":["[data-tech-title]"],"intro":["[data-tech-intro]"],"section1_title":["[data-tech-perspective-title]"],"section1_text":["[data-tech-perspective-text]"]};
