(function () {
  ...
  function linkHTML(item, lang) {
    ...
    const arrowHTML = item.link && item.link !== "#"
      ? `<a class="contact-arrow-link" href="${escapeHTML(item.link)}" target="_blank" rel="noopener noreferrer" aria-label="${lang === "en" ? "Open link" : "Abrir link"}">→</a>`
      : "";
